...
- 参加人数増加やワールド機能追加（例: Q-Sort入力）によりフレームレート低下の可能性あり

## 注意事項

- ブラウザの制約上、`LOG LOAD` でOSの任意フォルダを強制的に開くことはできません。
- VRChat側のログ出力形式が変わった場合、パーサ更新が必要になる可能性があります。

## 開発メモ

- このリポジトリはGitHub Pagesで配信しています。
- 変更反映後、Pagesの更新には数分かかる場合があります。
